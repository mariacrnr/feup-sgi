...
export class MyKeyframeAnimation extends MyAnimation{
	constructor(scene, isPiece = false) {
        super(scene);
    ...
    update(t){
        ...
        if(t < this.start){
            this.visible = false;
            if(this.isPiece) this.scene.gameOrchestrator.animator.inMove = false;
        }
        else if (t == this.start){
            this.visible = true;
            if(this.isPiece) this.scene.gameOrchestrator.animator.inMove = true;
